...
const Infobar = ({info}) => {
  ...
  return (
    <div className='w-[1110px] h-[160px] mt-[-80px] bg-white rounded-xl flex items-center '>
        <div className='w-full h-[80px] grid grid-cols-4 divide-x divide-black'  >
            ...
            <div className='flex item-center pl-10'> <Info title={'LOCATION'} info={info && (info.location.region) } /></div>
